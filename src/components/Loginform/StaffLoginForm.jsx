...
export default function StaffLoginForm() {
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
    try {
      const res = await fetch("http://localhost:8080/api/auth/staff/login", {
        method: "POST",
  ...
  return (
    <div className="container">
      <div className="form-container">
        <h3 className="text-center form-title">Staff Login</h3>
        <p className="text-center text-muted mb-4">Login to your staff account</p>
